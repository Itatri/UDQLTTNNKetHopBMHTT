...
namespace QuanLyHocVienTTNT
{
    ...
    public class EncryptCeaser
    {
        private OracleConnection conn;

        // Constructor to initialize the connection
        public EncryptCeaser()
        {
        ...
        public string EncryptCeaser_Func(string plaintext, int key)
        {
            ...
            try
            {
                ...
                string functionName = "quanlyTiengAnh.encryptCaesarCipher";
        ...
        public string EncryptMessageSDT(string message, int k)
        {
            string result = "";
            foreach (char c in message)
            {
        ...
        public string DecryptMessageSDT(string message, int k)
        {
            string result = "";
            foreach (char c in message)
            {
